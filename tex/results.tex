...
In tables \ref{table-first} to \ref{table-last} results obtained from algorithm described in \fref{sec:results-algorithm} are collected.
...
For detailed discussion regarding false-positive rates from surrogate data refer to \fref{sec:results-surrogate}.
...
grey for $r\ge0.1$ and green for $r<0.1$.
