...
\Fref{sec:methodology} decribes in details methodology used for data analysis.
Data sets used in this thesis are characterized in \fref{sec:data}, along with software used for data analysis.
\Fref{sec:results} gathers important results and provides commentary to the obtained results.
