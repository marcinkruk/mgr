...
In this research temporal features of time series is investigated, therefore random permutations of the original data sets is chosen as surrogate generating method.
