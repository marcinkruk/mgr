...
Then, 1000 surrogate data sets were generated with \emph{phase randomisation} method as described in \fref{sec:surrogate-method} and the same analysis procedure was perfomed for each realization.
...
$N=1000$ surrogate data sets were generated by \emph{phase randomisation} scheme, as described in \fref{sec:surrogate-method}.
